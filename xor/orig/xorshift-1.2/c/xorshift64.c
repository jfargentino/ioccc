...
void next0(void) { x ^= x << A; x ^= x >> B; x ^= x << C; y = REV(x * M); } // X1
void next1(void) { x ^= x >> A; x ^= x << B; x ^= x >> C; y = REV(x * M); } // X3
void next2(void) { x ^= x << C; x ^= x >> B; x ^= x << A; y = REV(x * M); } // X2
void next3(void) { x ^= x >> C; x ^= x << B; x ^= x >> A; y = REV(x * M); } // X4
void next4(void) { x ^= x << A; x ^= x << C; x ^= x >> B; y = REV(x * M); } // X5
void next5(void) { x ^= x >> A; x ^= x >> C; x ^= x << B; y = REV(x * M); } // X6
void next6(void) { x ^= x >> B; x ^= x << A; x ^= x << C; y = REV(x * M); } // X7
void next7(void) { x ^= x << B; x ^= x >> A; x ^= x >> C; y = REV(x * M); } // X8
#else

#define NAME "xorshift64"

void next0(void) { x ^= x << A; x ^= x >> B; x ^= x << C; y = x; }
void next1(void) { x ^= x >> A; x ^= x << B; x ^= x >> C; y = x; }
void next2(void) { x ^= x << C; x ^= x >> B; x ^= x << A; y = x; }
void next3(void) { x ^= x >> C; x ^= x << B; x ^= x >> A; y = x; }
void next4(void) { x ^= x << A; x ^= x << C; x ^= x >> B; y = x; }
void next5(void) { x ^= x >> A; x ^= x >> C; x ^= x << B; y = x; }
void next6(void) { x ^= x >> B; x ^= x << A; x ^= x << C; y = x; }
void next7(void) { x ^= x << B; x ^= x >> A; x ^= x >> C; y = x; }
