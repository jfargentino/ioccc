...
gcc -std=c99 -Wall xoroshiro128.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DADD -lprobdist -lmylib -ltestu01 -o xoroshiro128plus-crush-full
gcc -std=c99 -Wall xoroshiro128.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DADD -DREVERSE -lprobdist -lmylib -ltestu01 -o xoroshiro128plus-rev-crush-full
...
gcc -std=c99 -Wall xorshift1024.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DSTARPHI -lprobdist -lmylib -ltestu01 -o xorshift1024starphi-crush-full
gcc -std=c99 -Wall xorshift1024.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DSTARPHI -DREVERSE -lprobdist -lmylib -ltestu01 -o xorshift1024starphi-rev-crush-full
...
gcc -std=c99 -Wall pcg64.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -lprobdist -lmylib -ltestu01 -o pcg64-crush-full
gcc -std=c99 -Wall pcg64.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DREVERSE -lprobdist -lmylib -ltestu01 -o pcg64-rev-crush-full
...
gcc -std=c99 -Wall -DSFMT_MEXP=607 sfmt.c -O3 -I/usr/local/include -DHAVE_SSE2 -DTESTU01=bbattery_BigCrush -lprobdist -lmylib -ltestu01 -o sfmt607-crush-full
gcc -std=c99 -Wall -DSFMT_MEXP=607 sfmt.c -O3 -I/usr/local/include -DHAVE_SSE2 -DTESTU01=bbattery_BigCrush -DREVERSE -lprobdist -lmylib -ltestu01 -o sfmt607-rev-crush-full

gcc -std=c99 -Wall -DSFMT_MEXP=19937 sfmt.c -O3 -I/usr/local/include -DHAVE_SSE2 -DTESTU01=bbattery_BigCrush -lprobdist -lmylib -ltestu01 -o sfmt19937-crush-full
gcc -std=c99 -Wall -DSFMT_MEXP=19937 sfmt.c -O3 -I/usr/local/include -DHAVE_SSE2 -DTESTU01=bbattery_BigCrush -DREVERSE -lprobdist -lmylib -ltestu01 -o sfmt19937-rev-crush-full
...
gcc -std=c99 -Wall lehmer128.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -lprobdist -lmylib -ltestu01 -o lehmer128-crush-full
gcc -std=c99 -Wall lehmer128.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DREVERSE -lprobdist -lmylib -ltestu01 -o lehmer128-rev-crush-full
